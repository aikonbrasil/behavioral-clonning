...
history = model.fit_generator(train_sample, validation_data=val_sample, nb_val_samples=int(math.ceil(total_samples/10)), samples_per_epoch=total_samples, nb_epoch=1, verbose=1, callbacks=[checkpoint])
